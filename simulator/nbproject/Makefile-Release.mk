...
${TESTDIR}/tests/bugtest.o: tests/bugtest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bugtest.o tests/bugtest.cpp


${TESTDIR}/tests/martialarttest.o: tests/martialarttest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/martialarttest.o tests/martialarttest.cpp


${TESTDIR}/tests/worldtest.o: tests/worldtest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/worldtest.o tests/worldtest.cpp
...
${OBJECTDIR}/exception_nomain.o: ${OBJECTDIR}/exception.o exception.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception_nomain.o exception.cpp;\
	else  \
